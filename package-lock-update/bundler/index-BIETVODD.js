import { createElementBlock as r, openBlock as t, defineComponent as S, inject as T, resolveComponent as N, createVNode as b, unref as v, withCtx as O, createElementVNode as m, useTemplateRef as Q, markRaw as g, defineAsyncComponent as _, computed as A, normalizeClass as M, Fragment as z, renderList as F, createBlock as y, normalizeStyle as j, resolveDynamicComponent as I, ref as $, onMounted as U, nextTick as J, onBeforeUnmount as K, resolveDirective as V, withDirectives as P, createCommentVNode as w } from "vue";
import { _ as H, d as L, F as X, G as ee } from "./main-B25rq2zg.js";
...
const oe = {}, ne = { class: "border-b p-0 self-center w-2/3" };
function ie(f, i) {
  return t(), r("span", ne);
}
const G = /* @__PURE__ */ H(oe, [["render", ie]]), ae = /* @__PURE__ */ S({
  __name: "zoom-nav",
  setup(f) {
    const { t: i } = B(), o = T("iApi"), e = R(400, !0, () => o.geo.map.zoomIn()), p = R(400, !0, () => o.geo.map.zoomOut());
    return (a, n) => {
  ...
  setup(f) {
    const i = T("iApi"), { t: o } = B(), e = te();
    e.mapNavEl = Q("mapNavEl");
    const p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-DSY8gIfE.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-Cgs1EA-Q.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-4eW4a7S_.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-CBKgGpqr.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-CIcCkH-a.js")))
      }
    ], a = A(() => {
      const s = p.filter((u) => e.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-x76lDR4_.js")))
      }), s;
    }), n = (s) => {
...
}), Z = /* @__PURE__ */ H(se, [["__scopeId", "data-v-2036016d"]]), re = { class: "mapnav absolute right-0 bottom-0 pb-36 sm:pb-48 pr-12" }, le = ["content"], pe = { class: "mapnav-section bg-white-75 hover:bg-white" }, ce = {
  key: 1,
  class: "mapnav-section bg-white-75 hover:bg-white"
}, me = ["content"], ve = { key: 0 }, ue = /* @__PURE__ */ S({
  __name: "mapnav",
  setup(f) {
    const i = $(void 0), o = T("iApi"), e = L(), { t: p } = B(), a = $(), n = A(() => o.getConfig().fixtures.mapnav.items.some((c) => c === "draw")), l = $(o.$rootEl?.clientHeight), s = $(!1), u = $(0), x = () => {
    ...
    return (c, h) => {
      ...
      return t(), r("div", re, [
        P((t(), r("div", {
          ...
          b(ae, { class: "mapnav-section bg-white-75 hover:bg-white" }),
...
}), de = /* @__PURE__ */ H(ue, [["__scopeId", "data-v-d62d1b77"]]);
class he extends X {
...
class tt extends he {
  async added() {
    ...
    const { destroy: i, el: o } = this.mount(de, {
      app: this.$element
    });
