...
import { ref as f, computed as D, markRaw as ne, defineComponent as N, inject as Se, reactive as Le, watch as Ct, onBeforeUnmount as vt, resolveDirective as G, withDirectives as U, createElementBlock as w, openBlock as b, withKeys as ms, withModifiers as ei, onMounted as st, normalizeStyle as Pi, normalizeClass as ce, createVNode as fe, Transition as Ni, withCtx as ue, createBlock as ee, resolveDynamicComponent as ys, mergeProps as gs, useCssVars as vs, TransitionGroup as Fi, Fragment as tt, renderList as bt, unref as I, nextTick as Dt, renderSlot as Be, createElementVNode as m, vShow as bs, resolveComponent as ae, createTextVNode as ht, toDisplayString as B, createCommentVNode as z, onUpdated as As, Teleport as ws, getCurrentInstance as Es, useTemplateRef as yi, createApp as Di, toRaw as ke, h as xs, render as zt, defineAsyncComponent as Ss } from "vue";
import Ot from "@arcgis/core/Color";
...
import Ke from "@arcgis/core/request";
...
import { debounce as kt, throttle as ct } from "throttle-debounce";
import { createI18n as Ms, useI18n as ie } from "vue-i18n";
...
var Ge = /* @__PURE__ */ ((s) => (s.BLOB = "blob", s.DATE = "date", s.DOUBLE = "double", s.GEOMETRY = "geometry", s.GLOBAL_ID = "global-id", s.GUID = "guid", s.INTEGER = "integer", s.LONG = "long", s.OID = "oid", s.RASTER = "raster", s.SINGLE = "single", s.SMALL_INTEGER = "small-integer", s.STRING = "string", s.XML = "xml", s))(Ge || {}), De = /* @__PURE__ */ ((s) => (s.CIRCLE = "circle", s.CROSS = "cross", s.DIAMOND = "diamond", s.ICON = "icon", s.PATH = "path", s.SQUARE = "square", s.TRIANGLE = "triangle", s.X = "x", s))(De || {}), ge = /* @__PURE__ */ ((s) => (s.DASH = "dash", s.DASHDOT = "dash-dot", s.DASHDOTDOT = "short-dash-dot-dot", s.DOT = "dot", s.LONGDASH = "long-dash", s.LONGDASHDOT = "long-dash-dot", s.LONGDASHDOTDOT = "long-dash-dot-dot", s.NONE = "none", s.NULL = "none", s.SHORTDASH = "short-dash", s.SHORTDASHDOT = "short-dash-dot", s.SHORTDASHDOTDOT = "short-dash-dot-dot", s.SHORTDOT = "short-dot", s.SOLID = "solid", s))(ge || {}), Bi = /* @__PURE__ */ ((s) => (s.BEVEL = "bevel", s.MITER = "miter", s.ROUND = "round", s))(Bi || {}), zi = /* @__PURE__ */ ((s) => (s.ROUND = "round", s.BUTT = "butt", s.SQUARE = "square", s))(zi || {}), qi = /* @__PURE__ */ ((s) => (s.BDIAG = "backward-diagonal", s.CROSS = "cross", s.DIAG_CROSS = "diagonal-cross", s.FDIAG = "forward-diagonal", s.HORIZONTAL = "horizontal", s.NONE = "none", s.NULL = "none", s.SOLID = "solid", s.VERTICAL = "vertical", s))(qi || {}), $ = /* @__PURE__ */ ((s) => (s.POINT = "Point", s.MULTIPOINT = "MultiPoint", s.LINESTRING = "LineString", s.MULTILINESTRING = "MultiLineString", s.POLYGON = "Polygon", s.MULTIPOLYGON = "MultiPolygon", s.LINEARRING = "LinearRing", s.EXTENT = "Extent", s.NONE = "None", s.UNKNOWN = "Unknown", s))($ || {}), Gt = /* @__PURE__ */ ((s) => (s.Simple = "simple", s.Unique = "uniqueValue", s.ClassBreaks = "classBreaks", s.Unknown = "unknown", s))(Gt || {}), S = /* @__PURE__ */ ((s) => (s.FEATURE = "esri-feature", s.MAPIMAGE = "esri-map-image", s.TILE = "esri-tile", s.VECTORTILE = "esri-vector-tile", s.IMAGERY = "esri-imagery", s.IMAGERYTILE = "esri-imagery-tile", s.GRAPHIC = "esri-graphic", s.WMS = "ogc-wms", s.WFS = "ogc-wfs", s.GEOJSON = "file-geojson", s.GEOJSONZIPPED = "file-zip-geojson", s.CSV = "file-csv", s.SHAPEFILE = "file-shape", s.FLATGEOBUF = "file-fgb", s.FLATGEOBUFZIPPED = "file-zip-fgb", s.OSM = "osm-tile", s.DATACSV = "data-csv", s.DATAJSON = "data-json", s.DATATABLE = "data-esri-table", s.UNKNOWN = "unknown", s.SUBLAYER = "sublayer", s))(S || {}), ye = /* @__PURE__ */ ((s) => (s.FEATURE = "feature", s.GRAPHIC = "graphic", s.IMAGERY = "imagery", s.IMAGERYTILE = "imagery-tile", s.MAPIMAGE = "map-image", s.NOLAYER = "no-layer", s.OSM = "osm-tile", s.TILE = "tile", s.UNKNOWN = "unknown", s.VECTORTILE = "vector-tile", s.WMS = "wms", s))(ye || {}), le = /* @__PURE__ */ ((s) => (s.ESRI_FEATURE = "esriFeature", s.ESRI_RASTER = "esriRaster", s.ESRI_TILE = "esriTile", s.OSM_TILE = "osmTile", s.OGC_RASTER = "ogcRaster", s.UNKNOWN = "unknown", s))(le || {}), K = /* @__PURE__ */ ((s) => (s.POINT = "Point", s.MULTIPOINT = "MultiPoint", s.LINESTRING = "LineString", s.MULTILINESTRING = "MultiLineString", s.POLYGON = "Polygon", s.MULTIPOLYGON = "MultiPolygon", s))(K || {}), oe = /* @__PURE__ */ ((s) => (s.GEOMETRIC = "geometric", s.SYMBOLIC = "symbolic", s.HYBRID = "hybrid", s.NONE = "none", s))(oe || {}), j = /* @__PURE__ */ ((s) => (s.NEW = "new", s.INITIATING = "initiating", s.INITIATED = "initiated", s.TERMINATING = "terminating", s.TERMINATED = "terminated", s))(j || {}), Z = /* @__PURE__ */ ((s) => (s.NEW = "new", s.LOADING = "loading", s.LOADED = "loaded", s.ERROR = "error", s))(Z || {}), ve = /* @__PURE__ */ ((s) => (s.NOT_LOADED = "not-loaded", s.NOT_VISUAL = "not-visual", s.REFRESH = "refresh", s.UP_TO_DATE = "up-to-date", s))(ve || {}), ft = /* @__PURE__ */ ((s) => (s.ESRI = "esri", s.TEXT = "text", s.IMAGE = "image", s.HTML = "html", s.XML = "xml", s.JSON = "json", s.UNKNOWN = "unknown", s))(ft || {}), de = /* @__PURE__ */ ((s) => (s.SYMBOL = "symbol", s.GRID = "grid", s.EXTENT = "extent", s.INITIAL = "initial", s.API = "api", s.PERMANENT = "permanent", s))(de || {}), X = /* @__PURE__ */ ((s) => (s.BoundaryZoom = "boundaryZoom", s.Datatable = "datatable", s.Identify = "identify", s.Metadata = "metadata", s.Opacity = "opacity", s.Refresh = "refresh", s.Reload = "reload", s.Remove = "remove", s.Settings = "settings", s.Symbology = "symbology", s.Visibility = "visibility", s))(X || {});
class $e {
  attributes;
  geometry;
  style;
...
class re extends rt {
  ...
  rawArray;
  constructor(e, t, i, r) {
    super(e, t.sr || i), r ? this.rawArray = t.slice() : this.rawArray = re.parseXY(t);
  }
  ...
  static fromESRI(e, t) {
    return new re(t, [e.x, e.y], T.fromESRI(e.spatialReference), !0);
  }
  toESRI() {
    return new _s({
      x: this.x,
  ...
  static fromGeoJSON(e, t) {
    return new re(t, e.coordinates, T.fromGeoJSON(e.crs), !0);
  }
  toGeoJSON() {
...
class Ae extends rt {
  ...
  getAt(e) {
    return new re(this.childIdGenerator(e), this.rawArray[e], this.sr, !0);
  }
...
class Je extends Ae {
  ...
  static fromESRI(e, t) {
    return new Je(t, e.paths[0], T.fromESRI(e.spatialReference), !0);
  }
  toESRI() {
    return new Gi({
      paths: [this.toArray()],
  ...
  static fromGeoJSON(e, t) {
    return new Je(t, e.coordinates, T.fromGeoJSON(e.crs), !0);
  }
  toGeoJSON() {
...
class _e extends rt {
  ...
  getAt(e) {
    return new Je(this.childIdGenerator(e), this.rawArray[e], this.sr, !0);
  }
...
class Ue extends rt {
  rawArray;
  constructor(e, t, i, r) {
    super(e, t.sr || i), r ? this.rawArray = Ue.arrayDeepCopy(t) : this.rawArray = Ue.parseMultiPolygon(t);
  }
  addPolygon(e) {
   ...
   */
  toArray() {
    return Ue.arrayDeepCopy(this.rawArray);
  }
  ...
  static fromESRI(e, t) {
    return new Ue(t, [e.rings], T.fromESRI(e.spatialReference), !0);
  }
  toESRI() {
    const e = [];
...
class H extends rt {
  ...
  rawMax;
  constructor(e, t, i, r) {
    super(e, t.sr || r), this.rawMin = re.parseXY(t), this.rawMax = re.parseXY(i);
  }
...
class We extends Ve {
  ...
  _angle;
  constructor(e) {
    if (e = e || { style: De.CIRCLE }, super(), this._style = e.style || De.CIRCLE, e.style === De.ICON) {
      const t = e;
      this._icon = t.icon || "", this._height = Ve.convToPoints(t.height) || 16.5, this._width = Ve.convToPoints(t.width) || 16.5, this._size = 0, this._colour = new ze(), this._outline = new Pe(), this._path = "";
    } else {
      const t = e;
      this._size = Ve.convToPoints(t.size) || 12, this._colour = new ze(t.colour ?? "#ffffff40"), this._outline = new Pe(t.outline), this._path = this._style === De.PATH && t.path || "", this._height = 0, this._width = 0, this._icon = "";
    }
    this._xOffset = Ve.convToPoints(e.xOffset) || 0, this._yOffset = Ve.convToPoints(e.yOffset) || 0, this._angle = e.angle || 0;
  }
  ...
  propGrouse(e) {
    this._style === De.ICON !== e && console.warn(`Accessed a point style property that is invalid for the style type ${this._style}`);
  }
  toOptions() {
    const e = {
  ...
  toESRI() {
    let e;
    return this.styleType === De.ICON ? We.isImageUrl(this.icon) ? (e = new $s(), e.url = this.icon, e.width = this.width, e.height = this.height, e.xoffset = this.xOffset, e.yoffset = this.yOffset, e.angle = this.angle) : (e = new Yt(), e.color = new Ot(this.colour.rgba), e.size = this.width, e.xoffset = this.xOffset, e.yoffset = this.yOffset, e.angle = this.angle) : (e = new Yt(), e.color = new Ot(this.colour.rgba), e.size = this.size, e.xoffset = this.xOffset, e.yoffset = this.yOffset, e.angle = this.angle, e.path = this.path, e.style = this.styleType, e.outline = this.outline.toESRI()), e;
  }
  static fromESRI(e) {
    const t = {
      xOffset: e.xoffset,
    ...
    if (e.type === "simple-marker") {
      ...
      const i = t;
      i.style = De.ICON, i.width = e.width, i.height = e.height, i.icon = e.url;
    }
    return new We(t);
  }
  static fromArcServer(e) {
    return We.fromESRI(ii(e));
  }
  /**
...
class Pe extends Ve {
  ...
  _colour;
  constructor(e) {
    e = e || {}, super(), this._style = e.style || ge.SOLID;
    const t = Ve.convToPoints(e.width);
...
class Et extends Ve {
  ...
  toESRI() {
    const e = this.outline.toESRI(), t = new Ot(this.fillColour.rgba), i = new Cs();
...
class zs {
  ...
  esriMapClickToRamp(e, t) {
    return {
      mapPoint: re.fromESRI(e.mapPoint, t),
      screenX: e.x,
      screenY: e.y,
      button: e.button,
  ...
  geomEsriToRamp(e, t) {
    switch (e.type) {
      ...
      case "polyline": {
        const i = e;
        return i.paths.length === 1 ? Je.fromESRI(i, t) : _e.fromESRI(i, t);
      }
      case "polygon":
  ...
  styleEsriToRamp(e) {
    switch (e.type) {
      case "picture-marker":
      case "simple-marker":
        return We.fromESRI(e);
      case "simple-line":
        return Pe.fromESRI(e);
      case "simple-fill":
        return Et.fromESRI(e);
      default:
        return console.error(`Unsupported ESRI symbol type encountered: ${e.type}`), new We();
    }
  }
...
class Hs {
  ...
  async projectExtent(e, t) {
    ...
    const o = new he("warpy", [a], t.sr, !0), l = await this.projectGeometry(e, o), n = l.toArray().pop() || [], c = n.map((y) => y[0]), u = n.map((y) => y[1]), p = Math.min.apply(null, c), d = Math.max.apply(null, c), g = Math.min.apply(null, u), h = Math.max.apply(null, u);
  ...
  defaultHandlerFactory(e) {
    ...
    switch (e) {
      ...
      case "ramp_map_resize_updates_scalebar":
        this.$iApi.event.on(
          "map/resized",
          kt(100, () => this.$iApi.geo.map.caption.updateScale()),
          e
        );
        break;
      case "ramp_map_scale_updates_scalebar":
        this.$iApi.event.on(
          "map/scalechanged",
          kt(300, () => this.$iApi.geo.map.caption.updateScale()),
          e
        );
        break;
      case "ramp_panel_close_updates_appbar":
        t = (i) => {
          const r = Nt(this.$vApp.$pinia);
...
const Ft = W("maptip", () => {
  ...
  __name: "esri-map",
  setup(s) {
    const e = Ft(), t = Se("iApi"), i = D(() => e.maptipPoint), r = D(() => e.maptipInstance), a = D(() => e.content), o = Le([]), l = f(!1);
    o.push(
      Ct(i, () => {
        if (i.value) {
...
const rr = ["data-cy"], Ki = /* @__PURE__ */ N({
  ...
  function O() {
    ...
    for (let Ie = n.value.length - 1; Ie >= 0; Ie--) {
      const nt = n.value[Ie];
      let Fe = nt.width || Q;
      if (r.value ? Fe = E : Fe += we, nt.id === "grid" && (Fe = Math.max(Math.min(Fe, E), je)), (E >= Fe && !r.value || L.length === 0) && (E -= Fe, L.unshift(nt)), nt.id === "grid" && E < je)
        break;
    }
    ...
    !L.includes(s.value) && !r.value) {
      ...
      const nt = n.value.indexOf(s.value), Fe = n.value.indexOf(Ie), Bt = n.value.slice();
      Fe > -1 && (Bt.splice(nt, 1), Bt.splice(Fe, 0, s.value)), n.value = Bt;
    }
    i.value = E, u.value = L;
  }
  function F(E) {
  ...
  setup(s) {
    ...
    return st(() => {
      window.addEventListener(
        ...
        (!r.value || !r.value.contains(p.target)) && (e.value = !1);
      }), o.value.addEventListener("focus", c), o.value.addEventListener("blur", u), o.value.addEventListener("mouseover", c), o.value.addEventListener("mouseleave", u), Dt(() => {
        const p = {
          name: "overflowScroll",
          enabled: !0,
          phase: "main",
  ...
  const s = f([]), e = f({}), t = D(() => s.value.length >= 99 ? 99 : s.value.length);
  function i(c) {
    s.value = [c, ...s.value];
  }
  function r(c) {
  ...
  setup(s) {
    const e = Ne(), { t } = ie(), i = D(() => e.notificationNumber), r = () => e.clearAll();
    return (a, o) => {
...
class dr extends se {
  ...
  constructor(e) {
    ...
    }), this.notificationStore = Ne(this.$vApp.$pinia);
  }
  /**
...
class Zi extends se {
  notificationStore = Ne(this.$vApp.$pinia);
  id;
  message;
  type;
  messageList = [];
...
const hr = ["content"], fr = { class: "flex items-center text-left" }, mr = { class: "select-text cursor-text" }, yr = ["content", "aria-label"], gr = {
  ...
  setup(s) {
    const e = Ne(), { t } = ie(), i = s, r = f(!1), a = Le({
      [xe.WARNING]: "⚠",
      [xe.INFO]: "ℹ️",
      [xe.ERROR]: "❌"
    }), o = (n) => {
    ...
    return (n, c) => {
      ...
      return U((b(), w("li", {
        ...
        m("div", fr, [
          m("span", null, [
            ht(B(a[s.notification.type]) + " ", 1),
            m("span", mr, B(s.notification.message), 1)
          ]),
          c[4] || (c[4] = m("span", { class: "flex-grow" }, null, -1)),
          s.notification.messageList ? (b(), w("div", {
            key: 0,
            class: ce(["dropdown-icon p-4 pointer-events-none", { "transform -rotate-180": r.value }])
          }, c[2] || (c[2] = [
            m("svg", {
              xmlns: "http://www.w3.org/2000/svg",
              height: "24",
        ...
        s.notification.messageList && r.value ? (b(), w("div", gr, [
  ...
  setup(s) {
    ...
    const o = D(() => e.notificationStack);
    return (l, n) => {
      const c = G("focus-item"), u = G("focus-list"), p = G("tippy");
      return b(), w("div", null, [
        o.value.length > 0 ? U((b(), w("ul", {
          key: 0,
          ...
          (b(!0), w(tt, null, bt(o.value, (d, g) => (b(), w(tt, {
            key: d.message + g
          }, [
            g > 0 ? (b(), w("div", Ar)) : z("", !0),
            U(fe(vr, {
          ...
          m("span", null, B(I(t)("notifications.empty")), 1),
      ...
      return b(), ee(si, {
        ...
        header: ue(() => [
          m("div", Er, [
            ...
            i.value && i.value > 0 ? (b(), w("span", Sr, B(i.value), 1)) : z("", !0)
          ])
        ]),
        default: ue((c) => [
          m("div", Ir, [
            m("div", null, [
              m("h4", _r, B(I(t)("notifications.title")), 1),
              m("div", Tr, [
                U((b(), w("button", {
                  type: "button",
                  onClick: r,
...
}), $r = /* @__PURE__ */ qe(Rr, [["__scopeId", "data-v-3623a7d2"]]), Cr = { class: "flex hover:text-white" }, Or = ["aria-label"], kr = { class: "about-ramp-dropdown pointer-events-auto bg-white rounded w-256 h-50" }, Mr = ["aria-label", "content"], Pr = { class: "pb-8 border-b border-gray-600 mb-10" }, Nr = { class: "absolute right-5 top-5" }, Fr = { class: "select-text" }, Dr = { class: "font-bold cursor-text" }, Gr = { class: "text-sm cursor-text" }, Ur = { class: "font-bold cursor-text" }, Vr = { class: "ml-5 cursor-text" }, Br = /* @__PURE__ */ N({
        ...
        default: ue((g) => [
          m("div", kr, [
            m("div", null, [
              ...
              m("div", Fr, [
                m("div", null, [
                  m("span", Dr, B(r.value), 1),
                  m("span", Gr, " [" + B(a.value) + "] ", 1)
                ]),
                m("div", null, [
                  m("span", Ur, B(o.value[0]), 1),
                  m("span", Vr, B(o.value[1]), 1)
                ]),
...
}), zr = /* @__PURE__ */ qe(Br, [["__scopeId", "data-v-24f3a9dc"]]), qr = "S", jr = "__HELP__", Xi = W("keyboardnav", () => {
  ...
  __name: "map-caption",
  setup(s) {
    const e = Ye(), t = Xi(), i = be(), { t: r } = ie(), a = Se("iApi"), o = D(() => e.scale), l = D(() => e.attribution), n = D(() => e.coords), c = D(() => e.langtoggle), u = D(() => i.config.map), { keyChain: p, lastAction: d, chainState: g, namespaces: h, activeNamespace: y } = hs(t), A = D(() => {
    ...
    return (F, _) => {
      ...
      return b(), w("div", Hr, [
        ...
        A.value ? (b(), w("span", Kr, [
          m("span", Zr, [
            _[0] || (_[0] = m("span", { class: "chain-colon" }, ":", -1)),
            m("span", Qr, B(A.value.keys), 1),
            A.value.cursor ? (b(), w("span", Xr, "_")) : z("", !0),
            A.value.options ? (b(), w("span", ea, B(A.value.options), 1)) : z("", !0)
          ]),
          A.value.description ? (b(), w("span", ta, "- " + B(A.value.description) + "...", 1)) : z("", !0)
        ])) : l.value?.text.disabled ? z("", !0) : U((b(), w("span", ia, [
        ...
        _[1] || (_[1] = m("span", { class: "flex-grow w-15" }, null, -1)),
        m("div", sa, [
          n.value?.disabled ? z("", !0) : U((b(), w("div", ra, [
          ...
          o.value?.disabled ? z("", !0) : U((b(), w("button", {
            key: 1,
            type: "button",
          ...
          c.value?.disabled ? z("", !0) : (b(), ee(M, {
            ...
            header: ue(() => [
              m("span", na, B(I(r)("map.language.short")), 1)
            ]),
            default: ue(() => [
              (b(!0), w(tt, null, bt(v.value, (J, E) => (b(), w("a", {
                ...
                ht(B(I(r)("map.language." + J)) + " ", 1),
                J === I(a).$i18n.locale.value ? (b(), w("span", ca, B(I(r)("map.language.curr")), 1)) : z("", !0)
              ], 10, la))), 128))
            ]),
            _: 1
          }, 8, ["tooltip", "ariaLabel"]))
  ...
  setup(s) {
    const e = Ne(), t = Se("iApi"), { t: i } = ie(), r = D(() => e.notificationNumber);
    return (a, o) => {
      const l = G("tippy");
      return U((b(), w("button", {
        type: "button",
        ...
        r.value && r.value > 0 ? (b(), w("span", da, B(r.value), 1)) : z("", !0)
      ], 8, pa)), [
        [l]
      ]);
    };
  ...
  setup(s) {
    const e = Se("iApi"), { t } = ie(), i = f(!1), r = f(["app", "lists", "map", "keyboardNav"]), a = f([]), o = f(null), l = f(null);
    st(() => {
      a.value.push(
    ...
    return (c, u) => {
      ...
      return i.value ? (b(), w("div", {
        ...
        m("div", {
          ...
          m("div", ma, [
            m("h2", ya, B(I(t)("keyboardInstructions.title")), 1),
            fe(p, {
              class: "ml-auto",
  ...
  __name: "shell",
  setup(s) {
    const e = Se("iApi"), t = ut(), i = Ee(), r = it(), { t: a } = ie(), o = D(() => i.items.appbar), l = () => {
...
const La = /* @__PURE__ */ qe(Sa, [["render", Ta]]), Oe = "focus-list", Qe = "focus-item", Ra = "focus-icon", $a = "focus-container", yt = `[${Oe}],[${$a}]`, _t = "truncate-text", Tt = "show-truncate", dt = "focused", Zt = `button,input,select,a,textarea,[contenteditable],[${Oe}],[${Ra}],[tabIndex]`, Ca = {
  mounted(s, e) {
...
class Oa {
   ...
   */
  defocusItem(e) {
    e.classList.remove(dt), this.setTabIndex(-1, e), e._tippy && e._tippy.hide(), e.getAttribute(Qe) === Tt && e.querySelector(`[${_t}]`)?._tippy?.hide();
  }
  /**
   ...
   */
  focusItem(e) {
    e.classList.add(dt), this.setAriaActiveDescendant(e), this.setTabIndex(0, e), e.scrollIntoView({ block: "nearest" }), e._tippy && !this.isTapped && e._tippy.show(), e.getAttribute(Qe) === Tt && e.querySelector(`[${_t}]`)?._tippy?.show(), this.isTapped = !1;
  }
  /**
  ...
  onClick(e) {
    ...
    this.highlightedItem = t.closest(`[${Qe}]`) || t.closest(`[${Oe}]`) || this.highlightedItem, t.hasAttribute(`${Qe}`) && this.element.focus(), this.highlightedItem !== this.element ? this.focusItem(this.highlightedItem) : this.element.removeAttribute("aria-activedescendant");
  }
  /**
   ...
   */
  onFocus() {
    this.highlightedItem && !this.isClicked && (this.highlightedItem._tippy && this.highlightedItem._tippy.show(), this.highlightedItem.getAttribute(Qe) === Tt && this.highlightedItem.querySelector(`[${_t}]`)?._tippy?.show()), this.isClicked = !1, this.element.hasAttribute("aria-activedescendant") || this.highlightedItem === this.element ? this.highlightedItem !== this.element && this.focusItem(this.highlightedItem) : this.setAriaActiveDescendant(this.highlightedItem), es(this.element), this.highlightedItem && this.highlightedItem !== this.element && this.highlightedItem.setAttribute("tabindex", "-1");
  }
  /**
   ...
   */
  onBlur() {
    this.highlightedItem && (this.highlightedItem._tippy && this.highlightedItem._tippy.hide(), this.highlightedItem.getAttribute(Qe) === Tt && this.highlightedItem.querySelector(`[${_t}]`)?._tippy?.hide());
  }
  /**
...
const za = ["content"], qa = {
  ...
  setup(s, { expose: e }) {
    const { t } = ie(), i = it(), r = Nt(), a = Se("iApi"), o = yi("el"), l = yi("contentEl"), n = f();
    e({ el: o });
    const c = s, u = D(() => a.fixture.get("appbar") ? r.temporary : []), p = D(() => i.mobileView), d = D(() => i.reorderable), g = (v) => v.scrollHeight > v.clientHeight, h = () => !p.value && !c.panel.teleport, y = (v) => {
      c.panel.move(v), v === "left" && Dt(() => {
    ...
    return st(() => {
      ...
      return U((b(), w("div", {
        ...
        s.header ? (b(), w("header", qa, [
          ...
          U((b(), w("h2", ja, [
            v.$slots.header ? Be(v.$slots, "header", { key: 0 }) : (b(), w("div", Ha, B(I(t)(s.panel.alertName)), 1))
          ])), [
            [q]
          ]),
          ...
          m("div", {
            ...
            s.panel.teleport ? z("", !0) : (b(), w("div", Wa, [
              d.value ? (b(), ee(V, {
                key: 0,
                onClick: C[1] || (C[1] = (L) => y("left")),
                active: !s.panel.isLeftMostPanel
              }, null, 8, ["active"])) : z("", !0),
              d.value ? (b(), ee(O, {
                key: 1,
                onClick: C[2] || (C[2] = (L) => y("right")),
        ...
        s.content ? (b(), w("div", {
          ...
          v.$slots.content ? Be(v.$slots, "content", { key: 0 }) : A.value ? (b(), w("div", {
            key: 1,
  ...
  setup(s) {
    ...
    const r = async () => {
      ...
      const n = new re("geolocation", l, T.latLongSR(), !0);
  ...
  constructor(e, t) {
    It.get(t).then((i) => {
      i.data.definitions.forEach((r) => {
        Lt[e][r.code] = r.term.split(`${r.code}-`)[1];
      }), Object.keys(Lt[e]).forEach((r) => {
        this.allTypes[r] = Lt[e][r], this.validTypes[r] = Lt[e][r];
      }), this.typesFetched = !0;
    });
  }
...
async function jo(s, e) {
  ...
  return r.test(e) && !s.disabledSearchTypes.includes("LAT/LNG") ? (i = e.slice(0, -1), t = new Rt(s, i), await Jo(t)) : o.test(e) && !s.disabledSearchTypes.includes("FSA") ? (i = e.substring(0, 3).toUpperCase(), t = new Rt(s, i), await Ko(t)) : a.test(e) && !s.disabledSearchTypes.includes("NTS") ? (i = e.substring(0, 6).toUpperCase(), t = new Rt(s, i), await Zo(t)) : (i = encodeURIComponent(e.trim()), t = new Rt(s, i), await Qo(t)), s.customSources.length && await Ho(t, s.customSources), t;
}
const ai = async (s) => {
  const [e, t] = await Re(It.get(s));
...
class Li {
  ...
  constructor(e, t) {
    ...
    const u = t?.settings;
    let p, d, g, h, y, A;
    u ? (p = u.categories ? u.categories : [], d = u.sortOrder ? u.sortOrder : [], g = u.disabledSearchTypes ? u.disabledSearchTypes : [], h = u.maxResults > 0 ? u.maxResults : 100, y = !!u.officialOnly) : (p = [], d = [], g = [], h = 100, y = !1), A = t?.customSources ?? [], A = A.map((v) => ({
      ...v,
      onSearch: async (C) => {
...
class as extends se {
   ...
   */
  constructor(e, t, i) {
    super(e), this._uid = et.sharedUtils.generateUUID(), this._name = t.name, this._type = t.type ?? "placeholder", this._parent = i, this._children = [], this._loadPromise = new te(), this._hidden = t.hidden ?? !1, this._expanded = t.expanded ?? !0, this._visibility = !0, this._exclusive = t.exclusive ?? !1, this._controls = t.controls?.slice() ?? [
      "visibilityButton",
      "expandButton"
      /* Expand */
  ...
  toggleVisibility(e, t = !0) {
    if (this.visibility !== e) {
      if (this._visibility = e ?? !this.visibility, !this.exclusive)
        ...
        if (this._lastVisible && (!(this._lastVisible instanceof He) || this._lastVisible.layerControlAvailable(X.Visibility)))
          this._lastVisible.toggleVisibility(!0);
        else {
          const i = this.children.find(
            (r) => !(r instanceof He) || r.layerControlAvailable(X.Visibility)
          );
   ...
   */
  checkVisibility(e) {
    this instanceof He && !this.layerControlAvailable(X.Visibility) || (this.exclusive ? e.visibility ? (this.children.forEach((t) => {
      t.uid !== e.uid && t.toggleVisibility(!1, !1);
    }), this._lastVisible = e, this._visibility = !0, this instanceof He && this.layer && this.layer.layerExists && (this.layer.visibility = !0)) : (this._visibility = !1, this instanceof He && this.layer && this.layer.layerExists && (this.layer.visibility = !1), this._lastVisible = e) : this.children.some((t) => t.visibility) ? (this._visibility = !0, this._visibleChildren = this.children.filter((t) => t.visibility), this instanceof He && this.layer && this.layer.layerExists && (this.layer.visibility = !0)) : (this._visibility = !1, this._visibleChildren = [], this instanceof He && this.layer && this.layer.layerExists && (this.layer.visibility = !1)), this.parent && this.parent.checkVisibility(this));
  }
  /**
   ...
   */
  reload() {
    this._type = "placeholder", this._loadPromise = new te();
  }
  /**
...
class He extends as {
  ...
  load(e) {
    ...
    t && (this.layer = t, this._layerRedrawing = t.mapLayer && t.drawState !== ve.UP_TO_DATE, t.loadPromise().then(() => {
      this._layerInitVis = typeof this._layerInitVis < "u" ? this._visibility : t.visibility, super.load(), this.toggleVisibility(this._layerInitVis, !0, !0), t.visibility || this.setSymbologyVisibility(void 0, !1), this.handlers.push(
        ...
        this.$iApi.event.on(
          ...
          (i) => {
            this.layer.uid === i.layer.uid && (i.layer.drawState === ve.REFRESH ? this.layerRedrawing = !0 : setTimeout(() => {
              this.layerRedrawing = i.layer.drawState === ve.REFRESH;
            }, 500));
          }
        )
...
const sn = W("legend", () => {
  ...
  function a(n) {
    if (n.parent === void 0)
      ...
      if (!(n.item instanceof $i) && !(n.item instanceof He)) {
...
class un {
   ...
   */
  initialize(e, t, i) {
    const r = be(this.$vApp.$pinia), a = it(this.$vApp.$pinia), o = Ft(this.$vApp.$pinia);
    if (t?.configs !== void 0) {
   ...
   */
  reloadWorker(e, t) {
    const i = ut(this.$vApp.$pinia), r = Ne(this.$vApp.$pinia), a = be(this.$vApp.$pinia), o = Ee(this.$vApp.$pinia), l = Me(this.$vApp.$pinia), n = Jt(this.$vApp.$pinia), c = !!e;
  ...
  setLanguage(e) {
    if (this.$i18n.locale.value === e)
      return;
    const t = be(this.$vApp.$pinia), i = Ne(this.$vApp.$pinia), r = t.registeredLangs;
...
class dn extends se {
  ...
  pointZoomScale;
  constructor(e, t = "") {
    super(e), this.esriMap = void 0, this._basemapStore = [], this._viewPromise = new te(), this.handlers = [], this.pointZoomScale = 5e4, this.name = t;
  }
  noMapErr() {
  ...
  destroyMapView() {
    ...
    this._viewPromise = new te(), this.created = !1, this.handlers.forEach((e) => e.handler.remove()), this.handlers = [], this.esriView.map = null, this.esriView.container = null, this.esriView.spatialReference = null, this.esriView.extent = null, this.esriView.navigation = null, this.esriView.destroy(), delete this.esriView;
  }
  /**
...
class hn extends se {
   ...
   */
  constructor(e) {
    super(e), this.maptipStore = Ft(this.$vApp.$pinia);
  }
...
class fn extends se {
    ...
    if (e ? (e.logo ? e.logo.disabled ? r.logo.disabled = !0 : (r.logo.altText = e.logo.altText || i.altText, r.logo.link = e.logo.link || i.link, r.logo.value = e.logo.value || i.value) : (r.logo.altText = i.altText, r.logo.link = i.link, r.logo.value = i.value), e.text ? e.text.disabled ? r.text.disabled = !0 : r.text.value = e.text.value || t.value : r.text.value = t.value, Ye(this.$vApp.$pinia).setAttribution(r)) : (r.logo.altText = i.altText, r.logo.link = i.link, r.logo.value = i.value, r.text.value = t.value), !e || e.text?.disabled || !e.text) {
      ...
      if (n) {
        ...
        Promise.all(c).then((u) => {
          a = u.filter((d) => d?.copyright).map((d) => d.copyright).join(" | "), r.text.value = a || r.text.value || t.value, Ye(this.$vApp.$pinia).setAttribution(r);
        });
      }
    }
  }
   ...
   */
  updateScale() {
    const e = Ye(this.$vApp.$pinia), t = e.scale;
    if (t?.disabled)
      return;
...
class mn extends dn {
  ...
  async setBasemap(e) {
    ...
    if (a) {
      ...
      this._viewPromise = new te(), this.created = !1, this.$iApi.event.emit(x.MAP_REFRESH_START), this.destroyMapView(), this.createMapView(i), await this.viewPromise.then(() => {
  ...
  screenPointToMapPoint(e) {
    return this.esriView ? re.fromESRI(
      this.esriView.toMap({
        x: e.screenX,
        y: e.screenY
      }),
      "mappoint"
    ) : (this.noMapErr(), new re("i_am_error", [0, 0], void 0, !0));
  }
  /**
...
class _n extends se {
  ...
  extractCsvFields(e, t = ",") {
    return bi.dsvFormat(t).parseRows(e)[0].map((r) => ({ name: r, type: Ge.STRING }));
  }
  /**
   ...
   */
  inferType(e) {
    return typeof e == "number" ? Ge.DOUBLE : Ge.STRING;
  }
  /**
...
class Ln extends se {
  ...
  async loadWfsData(e, t = -1, i = 0, r = 1e3, a = {
    ...
    const c = new Pt(e).updateQuery(l), [u, p] = await Re(It.get(c));
    if (!p)
    ...
    if (a.features = a.features.concat(d.features), d.features.length < t - i) {
      ...
      return o && a.features.length > 0 && a.features[0].geometry.type === K.POINT && a.features.forEach((g) => {
...
class Rn extends se {
  ...
  async loadLayerMetadata(e) {
    ...
    const [t, i] = await Re(Ke(e, { query: { f: "json" } }));
    if (!i)
...
class ci extends se {
   ...
   */
  constructor(e, t) {
    super(t), this.config = e, this.id = "", this.uid = "", this.name = "error", this.layerState = Z.NEW, this.drawState = ve.NOT_LOADED, this.initiationState = j.NEW, this.layerIdx = -1, this.layerFormat = ye.UNKNOWN, this.layerType = S.UNKNOWN, this.dataFormat = le.UNKNOWN, this.supportsIdentify = !1, this.identifyMode = oe.NONE, this.supportsFeatures = !1, this.mapLayer = !0, this.featureCount = 0, this.fields = [], this.fieldList = "", this.nameField = "", this.tooltipField = "", this.oidField = "", this.supportsSublayers = !1, this.isSublayer = !1, this.isRemoved = !1, this.isFile = !1, this.isCosmetic = !1, this.isSystem = !1, this.userAdded = !1, this.identify = !1, this.hovertips = !1, this.geomType = $.UNKNOWN, this.legend = [], this._sublayers = [], this.expectedTime = { draw: 0, load: 0, fail: 0 }, this.lastCancel = 0, this.canModifyLayer = !0, this.canReload = !0, this.url = "";
  }
  /**
   ...
   */
  getLayerTree() {
    return new Mt(0, "Fake tree", "getLayerTree() was not implemented in layer");
  }
  /**
   ...
   */
  getGraphic(e, t) {
    return Promise.resolve(new $e(new Ze()));
  }
  /**
...
class os extends ci {
  ...
  constructor(e, t) {
    ...
    this.expectedTime.draw = e.expectedDrawTime ?? i.draw, this.expectedTime.load = e.expectedLoadTime ?? i.load, this.expectedTime.fail = e.maxLoadTime || i.fail, this.lastCancel = 0, this.timers = {
      draw: void 0,
      load: void 0
    }, this.origRampConfig = e, this.id = e.id || "", this.uid = this.$iApi.geo.shared.generateUUID(), this.isCosmetic = !1, this.isSystem = e.system || !1, this.isRemoved = !1, this.isSublayer = !1, this.supportsIdentify = !1, this.mapLayer = !0, this.identifyMode = oe.NONE, this.supportsFeatures = !1, this.hovertips = !1, this.supportsSublayers = !1, this.isFile = !1, this.layerState = Z.NEW, this.initiationState = j.NEW, this.drawState = ve.NOT_LOADED, this.loadDefProm = new te(), this.url = this.origRampConfig.url, this.canReload = !!(this.url || this.origRampConfig.caching), this.loadPromDone = !1, this.nameArcadeFormula = "", this.tooltipArcadeFormula = "", this.layerTree = new Mt(0, this.uid, this.name, !0);
  }
  updateInitiationState(e) {
  ...
  updateDrawState(e) {
    this.drawState = e, e === ve.REFRESH ? this.startTimer(
      "draw"
      /* DRAW */
    ) : e === ve.UP_TO_DATE && this.stopTimer(
      "draw"
      /* DRAW */
  ...
  async initiate() {
    ...
    clearTimeout(i), t > this.lastCancel && (this.drawState !== ve.UP_TO_DATE && this.startTimer(
      "draw"
      /* DRAW */
  ...
  async terminate() {
    this.updateInitiationState(j.TERMINATING), await Promise.all(this.sublayers.map((e) => e.terminate())), this.loadDefProm = new te(), this.loadPromDone = !1, this.updateLayerState(Z.NEW), this.updateDrawState(ve.NOT_LOADED), this.updateInitiationState(j.TERMINATED);
  }
  // ----------- LAYER LOAD -----------
    ...
    try {
      ...
      Promise.all(r).then(() => {
        clearTimeout(i), t ? this.visibility = !1 : (this.stopTimer(
          "load"
          /* LOAD */
        ), e > this.lastCancel && (this.loadPromDone && (this.loadDefProm = new te()), this.loadDefProm.resolveMe(), this.loadPromDone = !0, this.sublayers.forEach((a) => a.onLoad()), this.updateLayerState(Z.LOADED)));
      }).catch(() => {
  ...
  onError(e = !0) {
    this.layerState !== Z.ERROR && (this.initiationState === j.INITIATING && this.updateInitiationState(j.NEW), this.loadPromDone && (this.loadDefProm = new te()), this.loadDefProm.rejectMe(), this.loadPromDone = !0, this.sublayers.forEach((t) => t.onError(e)), e && this.$iApi.notify.show(
      xe.ERROR,
      this.$iApi.$i18n.t("layer.error", {
        id: this.id
      })
   ...
   */
  getGraphic(e, t) {
    return this.stubError(), Promise.resolve(new $e(new Ze()));
  }
  getIcon(e) {
    return this.stubError(), Promise.resolve("");
  }
...
class at extends os {
  ...
  // ----------- LAYER CONSTRUCTION AND INITIALIZAION -----------
  constructor(e, t) {
    super(e, t), this._scaleSet = new ji(), this._mouseTolerance = e.mouseTolerance != null ? e.mouseTolerance : 5, this._touchTolerance = e.touchTolerance != null ? e.touchTolerance : 15, this._drawOrder = [], this._serverVisibility = void 0, this.isCosmetic = e.cosmetic || !1, this.extent = e.extent ? H.fromConfig(`${this.id}_extent`, e.extent) : void 0, this.viewDefProm = new te(), this.esriWatches = [];
  }
  noLayerErr() {
    console.error(
    ...
    this.esriWatches.push(
      ...
      this.esriView = ne(e.layerView), this.esriWatches.push(
        Te(
          ...
          (t) => {
            this.updateDrawState(t ? ve.REFRESH : ve.UP_TO_DATE);
          }
        )
  ...
  async terminate() {
    this.esriWatches.forEach((e) => e.remove()), this.esriWatches = [], this.esriLayer = void 0, await super.terminate(), this.viewDefProm = new te();
  }
  async reload() {
    if (!this.$iApi.geo.map.esriMap) {
...
class ui extends at {
  ...
  filter;
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !0, this.geomType = $.UNKNOWN, this.serviceUrl = "", this.fieldList = "", this.canModifyLayer = !0, this.filter = new Hi(e.permanentFilteredQuery || "", e.initialFilteredQuery || ""), this.hovertips = e.state?.hovertips ?? !0, this.attribs = new ls();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
...
class $n extends at {
  constructor(e, t) {
    super(e, t), this.dataFormat = le.ESRI_FEATURE, this.layerFormat = ye.GRAPHIC, this.hovertips = !1;
  }
  _graphics = [];
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
...
class Cn extends $n {
  ...
  onLoadActions() {
    const e = super.onLoadActions();
    return this.layerTree.name = this.name, this.updateDrawState(ve.UP_TO_DATE), e;
  }
  // ----------- LAYER ACTIONS -----------
}
class ot extends ui {
  ...
  async getGraphic(e, t) {
    ...
    if (!t.getGeom && this.attribs.attLoader.isLoaded()) {
      ...
      i = new $e(new Ze(), "", r.features[r.oidIndex[e]]);
    } else {
      const r = {
        filterOIDs: [e],
...
class Gn extends at {
  ...
  origState;
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !0, this.supportsSublayers = !0, this.layerType = S.MAPIMAGE, this.layerFormat = ye.MAPIMAGE, this.isDynamic = !1, this.hovertips = !1, this.layerTree.layerIdx = -1, this.identifyMode = oe.GEOMETRIC;
  }
  async onInitiate() {
  ...
  onLoadActions() {
    ...
    const a = [], o = (n, c) => {
      ...
      if (n.sublayers && n.sublayers.length > 0) {
        const d = (p ? p.name : "") || n.title || "", g = new Mt(u, "", d, !1);
        ...
        if (d.name = p?.name || n.title || "", a.push(d), !c.children.map((g) => g.layerIdx).includes(u)) {
          const g = new Mt(u, d.uid, d.name, !1);
          c.children.push(g);
        }
        d.esriWatches.push(
          Te(
...
class Hn extends at {
  ...
  getFeatureInfo(e, t, i) {
    ...
    }), Object.keys(v).forEach((Y) => l[Y] = v[Y]), Ke(a.url.split("?")[0], {
      query: l,
      responseType: y
    });
  }
...
class Wn extends ot {
  ...
  async onInitiate() {
    const e = Date.now(), t = new Pt(this.config.url), { offset: i, limit: r } = t.queryMap, a = await this.$iApi.geo.layer.ogc.loadWfsData(
      this.config.url,
      -1,
      parseInt(i) || 0,
      parseInt(r) || 1e3,
...
class ns extends os {
  ...
  // ----------- LAYER CONSTRUCTION AND INITIALIZAION -----------
  constructor(e, t) {
    super(e, t), this.dataFormat = le.ESRI_FEATURE, this.layerFormat = ye.NOLAYER, this.drawState = ve.NOT_VISUAL, this.attribs = new ls(), this.supportsFeatures = !0, this.mapLayer = !1, this.isFile = !1, this._visibility = e.state?.visibility ?? !0, this.expectedTime.draw = 0;
  }
  async onInitiate() {
    if (this.sourceJson) {
      ...
      this.fields = t.map((c, u) => {
        ...
        return {
          ...
          alias: p,
          type: g,
          length: g === Ge.STRING ? 256 : void 0
        };
      }), this.oidField = "rampOID", this.fields.push({ name: this.oidField, type: Ge.OID }), e.fields.push(this.oidField), e.data.forEach((c, u) => c.push(u + 1)), this.$iApi.geo.attributes.applyFieldMetadata(this, this.origRampConfig.fieldMetadata), this.fieldList = "*";
      const a = {
        batchSize: -1,
...
class sl extends se {
  ...
  async symbolToSvg(e) {
    ...
    const a = lt(r).size(this.CONTAINER_SIZE, this.CONTAINER_SIZE).viewbox(0, 0, this.CONTAINER_SIZE, this.CONTAINER_SIZE), o = {
      ...
      [ge.DOT]: "1.333,4",
      // esriSLSDot
      [ge.DASHDOT]: "5.333,4,1.333,4",
      // esriSLSDashDot
      [ge.LONGDASH]: "10.666,4",
      // esriSLSLongDash
      [ge.LONGDASHDOT]: "10.666,4,1.333,4",
      // esriSLSLongDashDot
      [ge.LONGDASHDOTDOT]: "10.666,4,1.333,4,1.333,4",
      // esriSLSLongDashDotDot
      [ge.SHORTDOT]: "1.333,1.333",
      // esriSLSShortDot
      [ge.SHORTDASH]: "5.333,1.333",
      // esriSLSShortDash
      [ge.SHORTDASHDOT]: "5.333,1.333,1.333,1.333",
      // esriSLSShortDashDot
      [ge.SHORTDASHDOTDOT]: "5.333,1.333,1.333,1.333,1.333,1.333"
  ...
  async getMapServerLegend(e) {
    ...
    const t = {
      query: { f: "json" }
    }, i = { layers: [] }, [r, a] = await Re(Ke(`${e}/legend`, t));
...
class rl extends se {
  ...
  async geoJsonQuery(e) {
    ...
    return (await e.layer.esriLayer.queryFeatures(t)).features.map((r, a) => {
      let o;
      return t.returnGeometry ? o = this.$iApi.geo.geom.geomEsriToRamp(r.geometry, `queryResult${a}`) : o = new Ze(), new $e(o, "", r.attributes);
    });
  }
  /**
...
const ol = /* @__PURE__ */ Object.assign({ "../fixtures/appbar/index.ts": () => import("./index-BOh-soMZ.js"), "../fixtures/areas-of-interest/index.ts": () => import("./index-BQajFtD8.js"), "../fixtures/basemap/index.ts": () => import("./index-Bh4xLvsI.js"), "../fixtures/crosshairs/index.ts": () => import("./index-jB2sMx3S.js"), "../fixtures/details/index.ts": () => import("./index-Czlsi9Mx.js"), "../fixtures/draw/index.ts": () => import("./index-B3INTaf8.js"), "../fixtures/export-footnote/index.ts": () => import("./index-BKlECNnX.js"), "../fixtures/export-legend/index.ts": () => import("./index-Ntgv7NJG.js"), "../fixtures/export-map/index.ts": () => import("./index-B-s9A747.js"), "../fixtures/export-northarrow/index.ts": () => import("./index-Bb3j_Xda.js"), "../fixtures/export-scalebar/index.ts": () => import("./index-kDfgmsRf.js"), "../fixtures/export-timestamp/index.ts": () => import("./index-BlC9ETpU.js"), "../fixtures/export-title/index.ts": () => import("./index-MdV6aH8F.js"), "../fixtures/export/index.ts": () => import("./index-CDTJ9GBY.js"), "../fixtures/extentguard/index.ts": () => import("./index-BK1swDrb.js"), "../fixtures/gazebo/index.ts": () => import("./index-Coinm2gE.js"), "../fixtures/geosearch/index.ts": () => import("./index-zXjVFzRI.js"), "../fixtures/grid/index.ts": () => import("./index-CoEwTuta.js"), "../fixtures/help/index.ts": () => import("./index-Ir6OuD42.js"), "../fixtures/hilight/index.ts": () => import("./index-BrHBAe8N.js"), "../fixtures/keyboardnav/index.ts": () => import("./index-CBRmi_GZ.js"), "../fixtures/layer-reorder/index.ts": () => import("./index-DpBY3Mpp.js"), "../fixtures/legend/index.ts": () => import("./index-CkXc-3Mw.js"), "../fixtures/mapnav/index.ts": () => import("./index-BIETVODD.js"), "../fixtures/metadata/index.ts": () => import("./index-Yif7jOaf.js"), "../fixtures/northarrow/index.ts": () => import("./index-CkI2HY34.js"), "../fixtures/overviewmap/index.ts": () => import("./index-w-VgsaXy.js"), "../fixtures/panguard/index.ts": () => import("./index-5upZlS7C.js"), "../fixtures/scrollguard/index.ts": () => import("./index-e8n9o47K.js"), "../fixtures/settings/index.ts": () => import("./index-jVAoBC3a.js"), "../fixtures/snowman/index.ts": () => import("./index-g38N9ue-.js"), "../fixtures/swipe/index.ts": () => import("./index-D9b6AuZp.js"), "../fixtures/wizard/index.ts": () => import("./index-Bk0RCePO.js") });
class nl extends se {
  /**
...
class ll extends se {
  ...
  register(e, t) {
    ...
    const r = Object.entries(i).reduce((a, [o, l]) => (a.push(new $t(this.$iApi, o, l)), a), []);
  ...
  open(e) {
    let t, i, r;
    if (typeof e == "string" || e instanceof $t ? t = this.get(e) : (t = this.get(e.id), { screen: i, props: r } = e), !t)
      return t;
  ...
  toggle(e, t) {
    let i;
    return typeof e == "string" || e instanceof $t ? i = this.get(e) : i = this.get(e.id), i && (t = typeof t < "u" ? t : !i.isVisible, t !== i.isVisible ? t ? this.open(e) : this.close(i) : i);
  }
  /**
  ...
  toggleMinimize(e, t) {
    let i;
    return typeof e == "string" || e instanceof $t ? i = this.get(e) : i = this.get(e.id), i && (t = typeof t < "u" ? t : !i.isVisible, t !== i.isVisible ? t ? this.open(i) : this.minimize(i) : i);
  }
  /**
...
const dl = /* @__PURE__ */ qe(ul, [["render", pl], ["__scopeId", "data-v-a3c61802"]]), hl = /* @__PURE__ */ Object.assign({ "../fixtures/areas-of-interest/screen.vue": () => import("./screen-DwMvkreB.js"), "../fixtures/basemap/screen.vue": () => import("./screen-icVGgdYt.js"), "../fixtures/export/screen.vue": () => import("./screen-D5Lo-uHM.js"), "../fixtures/geosearch/screen.vue": () => import("./screen-Cms9u4-b.js"), "../fixtures/grid/screen.vue": () => import("./screen-dXXCvQ35.js"), "../fixtures/help/screen.vue": () => import("./screen-DQF8HPDD.js"), "../fixtures/layer-reorder/screen.vue": () => import("./screen-lk1jhhFm.js"), "../fixtures/legend/screen.vue": () => import("./screen-Cu9wO9Ob.js"), "../fixtures/metadata/screen.vue": () => import("./screen-Cjk17iK6.js"), "../fixtures/settings/screen.vue": () => import("./screen-Cow6B0DZ.js"), "../fixtures/wizard/screen.vue": () => import("./screen-4v5EmvyA.js") });
class $t extends se {
  /**
   * ID of this panel.
   *
...
var pt = { major: "4", minor: "15", patch: "0-beta", timestamp: "Tue Dec 2 15:17:29 2025 -0500", hash: "2309358772485dc52c0456a389331fdb1b11ef7a" };
console.info(
