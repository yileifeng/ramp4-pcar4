...
import "tiny-emitter";
import { G as le, L as Te, F as xe } from "./main-B25rq2zg.js";
...
class ft extends Me {
  async init() {
    Object.entries(Le).forEach((b) => this.$iApi.$i18n.mergeLocaleMessage(...b)), this._parseConfig(this.config), Z(this.$vApp.$pinia).supportedTypes.forEach((b) => {
      const o = `${b.type}-icon`;
      this.$iApi.component(o, Ae(Se(/* @__PURE__ */ Object.assign({ "./icons/circle-icon.vue": () => import("./circle-icon-CBKgGpqr.js"), "./icons/edit-icon.vue": () => import("./edit-icon-x76lDR4_.js"), "./icons/point-icon.vue": () => import("./point-icon-DSY8gIfE.js"), "./icons/polygon-icon.vue": () => import("./polygon-icon-4eW4a7S_.js"), "./icons/polyline-icon.vue": () => import("./polyline-icon-Cgs1EA-Q.js"), "./icons/rectangle-icon.vue": () => import("./rectangle-icon-CIcCkH-a.js") }), `./icons/${b.type}-icon.vue`, 3)));
    });
