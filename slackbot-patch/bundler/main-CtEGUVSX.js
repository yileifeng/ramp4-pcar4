...
class os extends ci {
  ...
  constructor(e, t) {
    ...
    this.expectedTime.draw = e.expectedDrawTime ?? i.draw, this.expectedTime.load = e.expectedLoadTime ?? i.load, this.expectedTime.fail = e.maxLoadTime || i.fail, this.lastCancel = 0, this.timers = {
      draw: void 0,
      load: void 0
    }, this.origRampConfig = e, this.id = e.id || "", this.uid = this.$iApi.geo.shared.generateUUID(), this.isCosmetic = !1, this.isSystem = e.system || !1, this.isRemoved = !1, this.isSublayer = !1, this.supportsIdentify = !1, this.mapLayer = !0, this.identifyMode = oe.NONE, this.supportsFeatures = !1, this.hovertips = !1, this.supportsSublayers = !1, this.isFile = !1, this.layerState = Z.NEW, this.initiationState = j.NEW, this.drawState = ye.NOT_LOADED, this.loadDefProm = new te(), this.url = this.origRampConfig.url, this.canReload = !!(this.url || this.origRampConfig.caching), this.loadPromDone = !1, this.nameArcadeFormula = "", this.tooltipArcadeFormula = "", this.layerTree = new Mt(0, this.uid, this.name, !0);
  }
  updateInitiationState(e) {
  ...
  async terminate() {
    this.updateInitiationState(j.TERMINATING), await Promise.all(this.sublayers.map((e) => e.terminate())), this.loadDefProm = new te(), this.loadPromDone = !1, this.updateLayerState(Z.NEW), this.updateDrawState(ye.NOT_LOADED), this.updateInitiationState(j.TERMINATED);
  }
  // ----------- LAYER LOAD -----------
...
class $n extends at {
  constructor(e, t) {
    super(e, t), this.dataFormat = le.ESRI_FEATURE, this.layerFormat = ge.GRAPHIC, this.hovertips = !1;
  }
  _graphics = [];
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
...
class Gn extends at {
  ...
  origState;
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !0, this.supportsSublayers = !0, this.layerType = S.MAPIMAGE, this.layerFormat = ge.MAPIMAGE, this.isDynamic = !1, this.hovertips = !1, this.layerTree.layerIdx = -1, this.identifyMode = oe.GEOMETRIC;
  }
  async onInitiate() {
...
const ol = /* @__PURE__ */ Object.assign({ "../fixtures/appbar/index.ts": () => import("./index-B1LDVXgd.js"), "../fixtures/areas-of-interest/index.ts": () => import("./index-CMhEbply.js"), "../fixtures/basemap/index.ts": () => import("./index-Cob7yYLx.js"), "../fixtures/crosshairs/index.ts": () => import("./index-BJ3NxivM.js"), "../fixtures/details/index.ts": () => import("./index-IFDK35un.js"), "../fixtures/draw/index.ts": () => import("./index-D6SFEtcU.js"), "../fixtures/export-footnote/index.ts": () => import("./index-C1f2N4Wl.js"), "../fixtures/export-legend/index.ts": () => import("./index-tqmub8iJ.js"), "../fixtures/export-map/index.ts": () => import("./index-QUofkbRk.js"), "../fixtures/export-northarrow/index.ts": () => import("./index-CI38livm.js"), "../fixtures/export-scalebar/index.ts": () => import("./index-ZAqMJlyQ.js"), "../fixtures/export-timestamp/index.ts": () => import("./index-CcOby8nc.js"), "../fixtures/export-title/index.ts": () => import("./index-DJWaAAbo.js"), "../fixtures/export/index.ts": () => import("./index-B9yK5sXk.js"), "../fixtures/extentguard/index.ts": () => import("./index-7ahN_mxz.js"), "../fixtures/gazebo/index.ts": () => import("./index-Dr3l1rqc.js"), "../fixtures/geosearch/index.ts": () => import("./index-BkgBPduj.js"), "../fixtures/grid/index.ts": () => import("./index-4HhugZ-g.js"), "../fixtures/help/index.ts": () => import("./index-BwOqW5vu.js"), "../fixtures/hilight/index.ts": () => import("./index-CnlBoaGS.js"), "../fixtures/keyboardnav/index.ts": () => import("./index-DhxC0SQE.js"), "../fixtures/layer-reorder/index.ts": () => import("./index-Bdp7SxMD.js"), "../fixtures/legend/index.ts": () => import("./index-XysqCxGO.js"), "../fixtures/mapnav/index.ts": () => import("./index-Duej8DmN.js"), "../fixtures/metadata/index.ts": () => import("./index-BkCMdzyE.js"), "../fixtures/northarrow/index.ts": () => import("./index-Bucq93G1.js"), "../fixtures/overviewmap/index.ts": () => import("./index-bH5Hn6Qx.js"), "../fixtures/panguard/index.ts": () => import("./index-Q72AuSaE.js"), "../fixtures/scrollguard/index.ts": () => import("./index-20pyLGYC.js"), "../fixtures/settings/index.ts": () => import("./index-9f4PdRXl.js"), "../fixtures/snowman/index.ts": () => import("./index-BPsTdch3.js"), "../fixtures/swipe/index.ts": () => import("./index-dYGXNQVC.js"), "../fixtures/wizard/index.ts": () => import("./index-DUw7aAEZ.js") });
class nl extends se {
  /**
...
const dl = /* @__PURE__ */ qe(ul, [["render", pl], ["__scopeId", "data-v-a3c61802"]]), hl = /* @__PURE__ */ Object.assign({ "../fixtures/areas-of-interest/screen.vue": () => import("./screen-M78LfTu8.js"), "../fixtures/basemap/screen.vue": () => import("./screen-4j8A2A6_.js"), "../fixtures/export/screen.vue": () => import("./screen-D4B2BeWR.js"), "../fixtures/geosearch/screen.vue": () => import("./screen-DHUI2aQw.js"), "../fixtures/grid/screen.vue": () => import("./screen-DpSEEpWj.js"), "../fixtures/help/screen.vue": () => import("./screen-CYJ-z6go.js"), "../fixtures/layer-reorder/screen.vue": () => import("./screen-LX5dd8ME.js"), "../fixtures/legend/screen.vue": () => import("./screen-CGn-gXKf.js"), "../fixtures/metadata/screen.vue": () => import("./screen-CLOqRtK0.js"), "../fixtures/settings/screen.vue": () => import("./screen-CPdF89b0.js"), "../fixtures/wizard/screen.vue": () => import("./screen-uxRJ_9R6.js") });
class $t extends se {
  /**
   * ID of this panel.
   *
...
var pt = { major: "4", minor: "15", patch: "0-beta", timestamp: "Thu Jan 29 08:27:26 2026 -0500", hash: "953d78821b53fc99170d9e8c9e1cc2f54c396de4" };
console.info(
