...
import { _ as H, d as L, F as X, G as ee } from "./main-CtEGUVSX.js";
...
const G = /* @__PURE__ */ H(oe, [["render", ie]]), ae = /* @__PURE__ */ S({
  ...
  setup(f) {
    ...
    const p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-BWeT6IAj.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-zSMrgel-.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-BcWCx8qX.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-CEnyt2so.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-RmbeKNfz.js")))
      }
    ], a = A(() => {
      const s = p.filter((u) => e.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-CnW4bMtf.js")))
      }), s;
    }), n = (s) => {
