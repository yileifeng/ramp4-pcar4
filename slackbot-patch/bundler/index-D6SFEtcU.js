...
import "tiny-emitter";
import { G as le, L as Te, F as xe } from "./main-CtEGUVSX.js";
...
class ft extends Me {
  async init() {
    Object.entries(Le).forEach((b) => this.$iApi.$i18n.mergeLocaleMessage(...b)), this._parseConfig(this.config), Z(this.$vApp.$pinia).supportedTypes.forEach((b) => {
      const o = `${b.type}-icon`;
      this.$iApi.component(o, Ae(Se(/* @__PURE__ */ Object.assign({ "./icons/circle-icon.vue": () => import("./circle-icon-CEnyt2so.js"), "./icons/edit-icon.vue": () => import("./edit-icon-CnW4bMtf.js"), "./icons/point-icon.vue": () => import("./point-icon-BWeT6IAj.js"), "./icons/polygon-icon.vue": () => import("./polygon-icon-BcWCx8qX.js"), "./icons/polyline-icon.vue": () => import("./polyline-icon-zSMrgel-.js"), "./icons/rectangle-icon.vue": () => import("./rectangle-icon-RmbeKNfz.js") }), `./icons/${b.type}-icon.vue`, 3)));
    });
