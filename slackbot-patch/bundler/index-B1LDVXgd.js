import { defineComponent as q, inject as j, computed as H, resolveComponent as K, createBlock as _, createCommentVNode as z, openBlock as s, unref as L, withCtx as V, createElementVNode as E, normalizeClass as I, createElementBlock as v, ref as w, watch as oe, onMounted as Q, onBeforeUnmount as Z, resolveDirective as P, withDirectives as T, renderSlot as ne, vShow as ee, nextTick as te, toDisplayString as re, onBeforeMount as ie, getCurrentInstance as F, onUpdated as se, createVNode as U, Fragment as $, renderList as C, resolveDynamicComponent as Y } from "vue";
import { useI18n as D } from "vue-i18n";
import { _ as G, u as ae, a as le, b as R, A as pe, F as ce, G as ue } from "./main-CtEGUVSX.js";
...
const fe = ["innerHTML"], O = /* @__PURE__ */ q({
...
}), ve = {}, he = { class: "border-b p-0 self-center w-2/3" };
function be(g, a) {
  return s(), v("span", he);
}
const J = /* @__PURE__ */ G(ve, [["render", be], ["__scopeId", "data-v-5d32b715"]]), ge = ["content", "aria-label"], ye = /* @__PURE__ */ q({
  __name: "more-button",
  props: {
    position: {
      type: String,
  ...
  setup(g, { expose: a, emit: l }) {
    ...
    return Q(() => {
      ...
      const f = P("focus-item"), h = P("tippy");
      return s(), v("div", {
...
}), $e = /* @__PURE__ */ G(ye, [["__scopeId", "data-v-87bcc276"]]), _e = {
  key: 0,
    ...
    return (e, x) => {
      ...
      return s(), _(u, {
        ...
        default: V(() => [
          ...
          d.value && d.value > 0 ? (s(), v("span", _e, re(d.value), 1)) : z("", !0)
        ]),
        _: 1
      }, 8, ["tooltip"]);
    };
  }
}), xe = /* @__PURE__ */ G(we, [["__scopeId", "data-v-787da765"]]), Ie = ["content"], ke = /* @__PURE__ */ q({
  __name: "appbar",
  setup(g) {
    const a = le(), l = R(), i = w(0), d = w(0), p = H(() => l.visible), e = H(() => l.temporary), { t: x } = D(), u = w(!1), c = w({}), b = w(), B = () => {
      ...
      o.key === "Tab" && b.value?.matches(":focus") && b.value._tippy.show();
    }, N = () => {
      const o = b.value;
      let m;
      const f = [...o.children];
    ...
    return Q(() => {
      ...
      const f = P("focus-list"), h = P("tippy");
      return T((s(), v("div", {
        ...
        U(xe, { class: "appbar-item bottom-48 h-48 sm:display-none" }),
        U(pe, {
...
class dt extends Ee {
  ...
  async added() {
    ...
    const { destroy: a, el: l } = this.mount(ke, {
      app: this.$element
