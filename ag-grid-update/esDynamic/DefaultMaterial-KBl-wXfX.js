import{o as L,H as Ue,s as Zt,A as $t,c as Me,r as Xt,g as ke,P as Kt,N as Qt}from"./vec32-6iMZOJAR.js";import{g1 as Te,az as x,cR as G,cY as _e,_ as c,X as A,Y as Ye,N as ea,dh as ta,gp as aa,ll as oa,hX as ra,o5 as Je,o6 as ia,o7 as na,hP as $,hO as Se,gv as qe,gn as sa,o8 as j,hW as ie,f7 as ne,av as la,eB as ca,aJ as da,dY as ua,cS as ha}from"./main-IG6wiSMH.js";import{a6 as V,i as se,d as le,a7 as O,a as Ze,a8 as ce,a9 as $e,aa as Xe,ab as ma,ac as B,ad as pa,ae as fa,af as va,f as ga,ag as X,r as I,a2 as K,D as H,E as W,ah as U,G as Q,b as y,I as k,ai as xa,H as ba,aj as wa,ak as Ke,q as de,al as Qe,o as et,am as tt,g as ya,j as Ce,k as ue,s as at,an as Ma,ao as Ta,u as _a,v as ot,ap as Sa,aq as _,ar as ze,as as Ca,at as za,c as ee,au as Fa,X as te,av as Na,M as Oa,aw as rt,ax as he,F as it,L as nt,K as st,ay as lt,J as ct,N as Ia,T as La,O as Va,P as Ra,Q as Ea,R as Pa,U as Da,V as Ga,W as Aa,Y as ja,x as m,A as Ba,az as Fe,aA as Ne,a1 as Ha,aB as Wa,B as Ua,aC as ka,a3 as Ya,aD as Ja}from"./OutputColorHighlightOID.glsl-CY0RoBjh.js";import{n as dt,r as qa}from"./vec4f64-DD-nkcCV.js";import{t as Oe,Q as Ie}from"./InterleavedLayout-BKrC-XMs.js";import{t as i,n as p}from"./glsl-CfY1Aoj6.js";import{s as S,T as ut,g as me,I as ht}from"./BufferView-UU7kEQwH.js";import{r as Za}from"./VertexBuffer-Cbx7nf-8.js";import{c as $a}from"./mat4-Dh0vBbD9.js";import{g as Xa}from"./plane-ClXX50ta.js";import{a as Ka,n as mt}from"./vec2f64-CkowXrDb.js";import{s as pe}from"./ShaderBuilder-B27MjMYr.js";import{T as Le,d as Ve,_ as Qa}from"./renderState-CsafAKLy.js";import{n as eo}from"./enums-DDJfd4_p.js";import{h as to,A as ao}from"./Texture-wUwIrVkj.js";import{s as C}from"./vec42-CRdkYl5g.js";import{t as oo}from"./VertexAttributeLocations-DBgVVQz-.js";function fe(e,t){switch(e.fragment.code.add(i`vec3 screenDerivativeNormal(vec3 positionView) {
...
return normal;
}`);break;default:Te(t.normalType);case 2:case 3:}}function ro({code:e,uniforms:t},a){t.add(new V("dpDummy",()=>1)),e.add(i`vec3 dpAdd(vec3 hiA, vec3 loA, vec3 hiB, vec3 loB) {
vec3 hiD = hiA + hiB;
vec3 loD = loA + loB;
...
float evaluateAmbientOcclusion() { return 0.0; }`)}function Rt(e,t){const a=e.fragment,r=t.lightingSphericalHarmonicsOrder!==void 0?t.lightingSphericalHarmonicsOrder:2;r===0?(a.uniforms.add(new B("lightingAmbientSH0",({lighting:o})=>L(Et,o.sh.r[0],o.sh.g[0],o.sh.b[0]))),a.code.add(i`vec3 calculateAmbientIrradiance(vec3 normal, float ambientOcclusion) {
...
}`))}const Et=x(),z=dt();function re(e){e.uniforms.add(new B("mainLightDirection",t=>t.lighting.mainLight.direction))}function q(e){e.uniforms.add(new B("mainLightIntensity",t=>t.lighting.mainLight.intensity))}function Vo(e){re(e.fragment),q(e.fragment),e.fragment.code.add(i`vec3 applyShading(vec3 shadingNormal, float shadow) {
...
}`)}function we(e){e.constants.add("ambientBoostFactor","float",za)}function ye(e){e.uniforms.add(new V("lightingGlobalFactor",t=>t.lighting.globalFactor))}function Ge(e,t){const a=e.fragment,{pbrMode:r,spherical:o,hasColorTexture:s}=t;a.include(be,t),r!==0&&a.include(De,t),e.include(Rt,t),a.include(ze),a.include(Pt,t);const n=!(r===2&&!s);switch(n&&a.include(Po),a.code.add(i`
...
}`),r){case 0:case 4:case 3:e.include(Vo),a.code.add(i`vec3 evaluateSceneLighting(vec3 normalWorld, vec3 albedo, float shadow, float ssao, vec3 additionalLight) {
...
inputs.groundIrradianceToSurface = GROUND_REFLECTANCE * ambientLightIrradianceComponent + mainLightIrradianceComponent + fillLightsIrradianceComponent ;`),a.uniforms.add(new V("lightingSpecularStrength",l=>l.lighting.mainLight.specularStrength),new V("lightingEnvironmentStrength",l=>l.lighting.mainLight.environmentStrength)).code.add(i`vec3 horizonRingDir = inputs.RdotNG * groundNormal - reflectedView;
...
}`)}let Wo=class extends se{constructor(e,t){super(e,"sampler2DShadow",0,(a,r)=>a.bindTexture(e,t(r)))}};function At(e,t){t.receiveShadows&&e.include(jo),jt(e,t)}function je(e,t){t.receiveShadows&&e.include(Bo),jt(e,t)}function jt(e,t){e.fragment.uniforms.add(new V("lightingGlobalFactor",o=>o.lighting.globalFactor));const{receiveShadows:a,spherical:r}=t;e.include(Do,t),a&&Uo(e),e.fragment.code.add(i`
...
metallicRoughnessUV = (metallicRoughnessTextureTransformMatrix * vec3(vuv0, 1.0)).xy;
  ...
  `)}function Be(e,t){t.snowCover&&(e.uniforms.add(new V("snowCover",a=>a.snowCover)).code.add(i`float getSnow(vec3 normal, vec3 groundNormal) {
