...
import { _ as H, d as L, F as X, G as ee } from "./main-CzU1FsrQ.js";
...
const G = /* @__PURE__ */ H(oe, [["render", ie]]), ae = /* @__PURE__ */ S({
  ...
  setup(f) {
    ...
    const p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-BiHsH0j4.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-K4uZXX-U.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-BsZ4QxKx.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-gBT25FAQ.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-2XQ3DCL7.js")))
      }
    ], a = A(() => {
      const s = p.filter((u) => e.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-Dn5ozk0L.js")))
      }), s;
    }), n = (s) => {
