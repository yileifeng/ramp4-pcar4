import { defineComponent as I, inject as ie, resolveComponent as Ve, createBlock as Xe, openBlock as _, unref as g, withCtx as ne, createElementBlock as E, Fragment as Je, renderList as et, createElementVNode as n, createTextVNode as H, createCommentVNode as S, toDisplayString as D, ref as w, onBeforeMount as ve, withDirectives as A, withKeys as P, withModifiers as V, normalizeClass as O, vModelText as oe, vModelSelect as Mt, onMounted as J, nextTick as _e, onBeforeUnmount as ee, resolveDirective as U, computed as N, useTemplateRef as kt, getCurrentInstance as Ft, watch as Ie, vShow as re, createVNode as Ee, markRaw as Ge } from "vue";
import "tiny-emitter";
import { a as fe, _ as ge, G as X, W as At, X as Tt, L as $t, Y as Rt, Z as tt, $ as se, i as lt, a0 as Ye, a1 as Le, a2 as Dt } from "./main-CzU1FsrQ.js";
...
class Qe {
   ...
   */
  constructor(s, e) {
    this.element = s, this.agGridApi = e, this.agGrid = this.element.querySelector(Ot), this.headerRows = Array.prototype.slice.call(
   ...
   */
  cellKeydownHandler(s, e, a) {
    s.key === "Enter" && s.target === e && (s.preventDefault(), a.forEach((l) => {
   ...
   * @param {HTMLElement[]} buttons The list of buttons in the cell
   */
  cellBlurHandler(s, e, a) {
    s.target === e && !a.includes(s.relatedTarget) && a.forEach((l) => {
   ...
   */
  cellButtonTabHandler(s, e, a, l) {
    s.key === "Tab" && (l && s.shiftKey || !l && !s.shiftKey) && (s.preventDefault(), e.focus(), a.forEach((o) => {
  ...
  scrollMouseDownHandler(s) {
    const e = this.element.querySelector(".ag-body-horizontal-scroll-viewport"), a = e.scrollLeft, l = s.clientX;
...
function Kt(L) {
  const s = L.previousHeaderPosition.column, e = L.previousHeaderPosition.headerRowIndex;
  let a = L.backwards ? e - 1 : e + 1;
  return a === -1 ? !1 : (a === L.headerRowCount && (a = -1), { headerRowIndex: a, column: s });
}
function jt(L) {
...
const qt = ["onClick"], Wt = { class: "md-icon-small inline" }, Yt = {
      ...
      return _(), Xe(o, {
        ...
        default: ne(() => [
          (_(!0), E(Je, null, et(L.columnDefs.filter(
            (d) => d.headerName && d.headerName.length > 0 && !(!g(s).ui.exposeOids && L.systemCols?.has(d.headerName)) && !(!g(s).ui.exposeMeasurements && (L.systemCols?.has(d.headerName) || L.systemCols?.has(d.field)))
          ), (d) => (_(), E("a", {
            key: d.headerName,
            onClick: (p) => {
  ...
  props: ["params"],
  setup(L) {
    const s = fe(), { t: e } = B(), a = L, l = w(""), o = w(""), d = w(a.params.stateManager.columns[a.params.column.colDef.field].filter.static), p = () => {
  ...
  props: ["params"],
  setup(L) {
    const s = fe(), { t: e } = B(), a = L, l = w(""), o = w(a.params.stateManager.columns[a.params.column.colDef.field].filter.static), d = () => {
  ...
  props: ["params"],
  setup(L) {
    const s = L, e = w(""), a = w([]), l = w(s.params.stateManager.columns[s.params.column.colDef.field].filter.static), o = () => {
      e.value = e.value ? e.value : "";
      const d = s.params.column.colDef.field;
      e.value === "..." || !e.value ? (s.params.api.setColumnFilterModel(d, null), e.value = "") : s.params.api.setColumnFilterModel(d, {
        filterType: "text",
        type: "contains",
        filter: e.value
    ...
    return ve(() => {
      ...
      let d = s.params.rowData;
      d = d.map((p) => p[s.params.column.colId]), a.value = d.filter((p, m) => d.indexOf(p) === m), a.value.unshift("..."), o();
    }), (d, p) => (_(), E("div", ol, [
      A(n("select", {
  ...
  props: ["params"],
  setup(L) {
    const s = L, { t: e } = B(), a = w(), l = w(), o = w(), d = () => s.params.clearFilters();
    return J(async () => {
  ...
  props: ["params"],
  setup(L) {
    const { t: s } = B(), e = L, a = w(), l = w(0), o = w(!1), d = w(!1), p = w(!1), m = w(null), y = () => {
      const c = m.value?.getAllDisplayedColumns(), M = c.indexOf(e.params.column), $ = c[M - 1]?.colDef, K = c[M + 1]?.colDef;
      d.value = M > 3 && !($?.headerComponentParams?.isStatic ?? $?.isStatic), p.value = M < c.length - 1 && !(K?.headerComponentParams?.isStatic ?? K?.isStatic);
    }, C = () => {
    ...
    return J(() => {
      ...
      return _(), E("div", {
        ...
        o.value ? (_(), E("div", xl, [
          A((_(), E("button", {
            type: "button",
            onClick: M[0] || (M[0] = (te) => x(te)),
            content: g(s)(`grid.header.sort.${l.value}`),
            "aria-label": g(s)(`grid.header.sort.${l.value}`),
            class: "customHeaderLabel hover:bg-gray-300 font-bold p-8 max-w-full",
            role: "columnheader",
            tabindex: "-1"
          }, [
            A((_(), E("div", null, [
              H(D(L.params.displayName), 1)
            ])), [
              [$, { externalTrigger: !0 }]
            ])
          ], 8, Cl)), [
        ...
        o.value ? (_(), E("div", _l, [
          ...
          A((_(), E("button", {
            type: "button",
            content: g(s)("grid.header.reorder.left"),
            "aria-label": g(s)("grid.header.reorder.left"),
            onClick: M[1] || (M[1] = (te) => C()),
          ...
          A((_(), E("button", {
            type: "button",
            content: g(s)("grid.header.reorder.right"),
            "aria-label": g(s)("grid.header.reorder.right"),
            onClick: M[2] || (M[2] = (te) => h()),
  ...
  props: ["params"],
  setup(L) {
    const s = L, { t: e } = B(), a = ie("iApi"), l = w(), o = async () => {
      const d = s.params.data, p = d.rvUid, m = a.geo.layer.getLayer(p), y = m.oidField, h = s.params.layerCols[m.id].find(
        (c) => c.origAttr === y
      ...
      a.event.emit(
        ...
        !0
      ), s.params.isTeleport && a.scrollToInstance();
    };
    return J(() => {
      s.params.eGridCell.addEventListener("keydown", (d) => {
        d.key === "Enter" && o();
      ...
      s.params.eGridCell.removeEventListener("keydown", (d) => {
        d.key === "Enter" && o();
  ...
  props: ["params"],
  setup(L) {
    const s = w("none"), e = L, a = ie("iApi"), l = Tt(), o = w(), { t: d } = B(), p = N(() => {
      ...
      C === "zoomed" || C === "error" ? setTimeout(() => {
        s.value = C, o.value?._tippy.show(), setTimeout(() => {
    ...
    return J(() => {
      ...
      return p.value ? A((_(), E("button", {
        ...
        type: "button",
        class: "flex items-center justify-center w-40 h-36",
        content: g(d)(`grid.cells.zoom${s.value === "none" ? "" : `.${s.value}`}`),
        onClick: m,
        tabindex: "-1",
        ref_key: "button",
        ref: o,
        "aria-label": g(d)(`grid.cells.zoom${s.value === "none" ? "" : `.${s.value}`}`)
      }, [
        s.value === "zooming" ? (_(), E("div", Sl)) : s.value === "zoomed" ? (_(), E("svg", Il, h[0] || (h[0] = [
          n("path", {
            "stroke-linecap": "round",
            "stroke-linejoin": "round",
            d: "M4.5 12.75l6 6 9-13.5"
          }, null, -1)
        ]))) : s.value === "error" ? (_(), E("svg", Gl, h[1] || (h[1] = [
          n("path", {
            "stroke-linecap": "round",
            "stroke-linejoin": "round",
  ...
  props: ["params"],
  setup(L) {
    const s = L, e = ie("iApi"), a = w(), l = N(() => {
      const d = Object.assign({}, s.params.data), p = e.geo.layer.getLayer(d.rvUid), m = s.params.config.displayOn;
      return !(!p || m === "geo" && !p.mapLayer || m === "data" && p.mapLayer);
    }), o = () => {
      const d = Object.assign({}, s.params.data), p = e.geo.layer.getLayer(d.rvUid), m = s.params.layerCols[p.id].find((C) => C.origAttr === p.oidField), y = m.mappedAttr ? d[m.mappedAttr] : d[m.origAttr];
      p.getGraphic(y, { getAttribs: !0 }).then((C) => {
        e.event.emit(s.params.config.actionEvent, {
          data: C.attributes,
          layer: p,
          uid: s.params.data.rvUid,
          oid: y
        });
      });
    };
  ...
  props: ["params"],
  setup(L) {
    const s = fe(), e = ie("iApi"), { t: a } = B(), l = w(), o = w(), d = w(!1), p = L, m = N(() => s.mobileView), y = () => {
      o.value?.textContent && (d.value = !0, l.value?._tippy.show(), navigator.clipboard.writeText(o.value?.textContent), setTimeout(() => {
        d.value = !1;
      }, 2e3));
    }, C = N(() => p.params.type === "number" ? p.params.value == null ? "" : e.ui.formatNumber(p.params.value) : p.params.type === "date" ? p.params.value == null ? "" : new Date(p.params.value).toISOString().slice(0, 10) : p.params.type === "string" ? !p.params.value || /<a[^>]*>[^<]+<\/a>/g.test(p.params.value) ? p.params.value : St(p.params.value, {
      target: "_blank",
      validate: {
        url: (x) => /^https?:\/\//.test(x)
        // only links that begin with a protocol will be hyperlinked
      }
    }) : ""), h = N(() => /<a[^>]*>[^<]+<\/a>/g.test(p.params.value) || /(http(s)?:\/\/.*)/g.test(p.params.value));
    return J(() => {
...
}, ia = ["aria-label"], ua = { class: "pb-2 flex ml-auto justify-end" }, da = ["content", "aria-label"], pa = ["aria-label"], ca = { class: "md-icon-small inline items-start" }, ma = {
  key: 0,
  height: "18",
  width: "18",
  viewBox: "0 0 24 24",
  ...
  viewBox: "0 0 24 24",
  class: "inline float-right"
}, ha = ["aria-label"], ya = { class: "md-icon-small inline items-start" }, ba = {
  key: 0,
  height: "18",
  width: "18",
  viewBox: "0 0 24 24",
  ...
  viewBox: "0 0 24 24",
  class: "inline float-right"
}, _a = ["aria-label"], Ea = ["content"], Ma = /* @__PURE__ */ I({
  ...
  setup(L) {
    ...
    const s = [se.OID, se.DOUBLE, se.SINGLE, se.INTEGER], e = ie("iApi"), a = lt(), l = fe(), o = N(() => l.mobileView), d = w(!o.value), p = w(), m = kt("gridContainer"), { t: y, locale: C } = B(), h = () => Ft()?.proxy?.$forceUpdate(), x = L, c = w({
      id: "dummy",
      layerIds: [],
      state: new Gt(),
      fieldMap: {}
    }), M = w(!0), $ = w(null), K = w(), te = w(), j = w(!1), le = w(!1), ue = w([]), Me = w(0), Y = w([]), he = w([]), ke = w(""), ae = w([]), de = w([]), ye = w("OBJECTID"), Fe = w(void 0), at = Qe.onCellKeyPress, q = w({ firstRow: 0, lastRow: 0, visibleRows: 0 }), be = w({}), rt = e.geo.layer.getLayer(x.gridId), pe = w({}), st = w(a.grids[x.gridId].layerIds), G = N(() => a.grids[x.gridId] ? a.grids[x.gridId].layerIds.map((r) => e.geo.layer.getLayer(r)).filter((r) => r !== void 0) : []), Ae = w(/* @__PURE__ */ new Set()), we = w([]), T = N(() => $.value), xe = () => {
      ...
      $.value = r.api, ke.value = c.value.state.title || rt?.name || x.gridId, $e(), de.value.length > 0 && T.value.autoSizeAllColumns(), xe(), T.value.addEventListener("rowDataUpdated", xe), Y.value.push(
        e.event.on(X.FILTER_CHANGE, ({ uid: t, filterKey: f }) => {
          f !== Le.GRID && t && G.value.map((i) => i.uid).includes(t) && Z();
        })
      ), Y.value.push(
        e.event.on(
          X.LAYER_VISIBILITYCHANGE,
          ({ layer: t }) => {
            t.uid && G.value.map((f) => f.uid).includes(t.uid) && Z();
          }
        )
      ), Y.value.push(
        e.event.on(X.LAYER_RELOAD_END, (t) => {
          t.loadPromise().then(() => {
            G.value.map((f) => f.uid).includes(t.uid) && Z();
          });
        })
      ), Y.value.push(
        e.event.on(X.LANG_CHANGE, () => {
          T.value.redrawRows({
            force: !0
          });
        })
        ...
        e.event.on(
          X.MAP_EXTENTCHANGE,
          Ze(100, () => {
            c.value.state.filterByExtent && Z();
          })
        )
      ), Y.value.push(
        e.event.on(X.LAYER_REMOVE, (t) => {
      ...
      c.value.state.filterByExtent = !c.value.state.filterByExtent, Z();
    }, dt = () => {
      ...
      $.value && !j.value && (c.value.state.searchFilter !== "" && Te(), c.value.state.applyToMap && Re(), _e(() => {
      ...
      q.value.firstRow = T.value.getFirstDisplayedRowIndex() + 1, q.value.lastRow = T.value.getLastDisplayedRowIndex() + 1, q.value.visibleRows = T.value.getDisplayedRowCount();
    }, Be = () => {
      ...
      return i.forEach((k) => {
        let F = !0, b = "";
        for (const R of f) {
          const W = new RegExp(`.*${R.split(" ").join(".*").toUpperCase()}`), qe = `%${R.replace(/\*/g, "%").split(" ").join("%").toUpperCase()}`;
          let ce = !1;
          for (const Se of u ?? []) {
            ...
            if (k.data[me] === void 0)
              ...
              const Q = k.data[me] === null ? null : k.data[me].toString();
              if (Q !== null && W.test(Q.toUpperCase())) {
              ...
              const Q = k.data[me] === null ? null : k.data[me];
              if (Q !== null && W.test(Q)) {
                b ? b = b.concat(" AND ", `(${Ce} = ${Q})`) : b = b.concat("(", `(${Ce} = ${Q})`), ce = !v.includes(b + ")");
                break;
              }
            }
          }
      ...
      (j.value || le.value) && G.value.forEach((r) => {
        ...
        Promise.all(t).then((f) => {
          ...
          f.forEach((u, v) => {
            ...
            u.columns.forEach((b) => {
              ...
              u.rows.map((b) => {
                if (c.value.fieldMap)
                  for (const [R, W] of Object.entries(c.value.fieldMap))
                    b[R] !== void 0 && b[W] === void 0 && (b[W] = b[R], delete b[R]);
                return b;
              })
            );
            ...
            const v = c.value.state?.columns[u.data], k = v.filter.type === "selector", F = {
              ...
              suppressHeaderKeyboardEvent: (R) => {
                const W = R.event;
                return R.headerRowIndex === 0 && (W.key === "Enter" || !W.target.classList.contains("ag-header-cell") && W.key === "Tab");
              }
            }, b = i.fields.find((R) => R.name === F.field);
            u === "rvRowIndex" || u === "rvSymbol" || u === "rvInteractive" ? ht(F, ae.value, c.value.state) : (s.indexOf(b.type) > -1 ? (ft(F, c.value.state), F.filter = "agNumberColumnFilter", F.autoHeight = !0, F.cellRenderer = v.template === "" ? Pe : e.component(v.template), F.cellRendererParams = {
              type: "number"
            }) : b.type === se.DATE ? (mt(F, c.value.state), F.filter = "agDateColumnFilter", F.autoHeight = !0, F.minWidth = 400, F.cellRenderer = v.template === "" ? Pe : e.component(v.template), F.cellRendererParams = {
              type: "date"
            }) : b.type === se.STRING && (k ? vt(F, i.rows, c.value.state) : gt(F, c.value.state), F.filter = "agTextColumnFilter", F.autoHeight = !0, F.cellRenderer = v.template === "" ? Pe : e.component(v.template), F.cellRendererParams = {
              type: "string"
            }), ae.value.push(F));
          }), de.value = Ge(i.rows), ae.value = Ge(ae.value), $e(), j.value = !1;
        }).catch((f) => {
          console.error(f), le.value = !0, j.value = !1;
        });
      });
    }, Ke = (r) => {
    ...
    return J(() => {
      ...
      c.value = a.grids[x.gridId], j.value = !0, h(), q.value = {
        firstRow: 0,
        lastRow: 0,
        visibleRows: 0
      }, te.value = {
      ...
      }, Ue(), z.value === "partial" && e.notify.show(Ye.WARNING, e.$i18n.t("layer.filterwarning")), he.value.push(
        Ie(C, () => {
      ...
      Oe(), Y.value.forEach((r) => e.event.off(r)), he.value.forEach((r) => r()), Fe.value?.removeAccessibilityListeners(), Fe.value?.removeScrollListeners(), m.value?.removeEventListener("keyup", Ke), m.value?.removeEventListener("blur", je);
    }), (r, t) => {
      const f = Ve("dropdown-menu"), i = U("truncate"), u = U("tippy");
      return _(), E("div", {
        ...
        A(n("div", null, [
          n("p", Ul, D(g(y)("grid.splash.error")), 1)
        ], 512), [
          [re, le.value]
        ]),
        A(n("div", Kl, [
          n("div", jl, [
            n("span", ql, D(ue.value.reduce((v, k) => v + k, 0)), 1),
            t[12] || (t[12] = n("svg", {
            ...
            n("span", Wl, D(Me.value), 1)
          ]),
          n("div", Yl, [
            n("span", Zl, D(ue.value.reduce((v, k) => v + k, 0) < Me.value ? g(y)("grid.splash.loading") : g(y)("grid.splash.building")), 1)
          ]),
          n("div", null, [
            n("button", {
              type: "button",
        ...
        A(n("div", Xl, [
          n("div", Jl, [
            ...
            A((_(), E("div", ta, [
              H(D(g(y)("grid.filters.label.info", {
                range: q.value.visibleRows !== 0 ? `${q.value.firstRow} - ${q.value.lastRow}` : "0",
                total: q.value.visibleRows
              })) + " ", 1),
              q.value.visibleRows !== de.value.length ? (_(), E("span", la, D(g(y)("grid.filters.label.filtered", {
                max: de.value.length
              })), 1)) : S("", !0)
            ])), [
              [i]
              ...
              Ee(f, {
                ...
                default: ne(() => [
                  n("a", {
                    ...
                    onClick: t[7] || (t[7] = (v) => z.value !== "disabled" && wt()),
                    role: "button",
                    ...
                    n("div", ca, [
                      ...
                      H(" " + D(g(y)("grid.label.filters.apply")) + " ", 1),
                      z.value !== "disabled" && c.value.state.applyToMap ? (_(), E("svg", ma, t[17] || (t[17] = [
                        n("g", { id: "done" }, [
                          n("path", { d: "M9 16.2L4.8 12l-1.4 1.4L9 19 21 7l-1.4-1.4L9 16.2z" })
                        ], -1)
                      ]))) : S("", !0)
                  ...
                  n("a", {
                    ...
                    n("div", fa, [
                      ...
                      H(" " + D(g(y)("grid.label.filters.show")) + " ", 1),
                      c.value.state.colFilter ? (_(), E("svg", ga, t[19] || (t[19] = [
                        n("g", { id: "done" }, [
                          n("path", { d: "M9 16.2L4.8 12l-1.4 1.4L9 19 21 7l-1.4-1.4L9 16.2z" })
                        ], -1)
                      ]))) : S("", !0)
                  ...
                  n("a", {
                    ...
                    onClick: t[9] || (t[9] = (v) => z.value !== "disabled" && ut()),
                    role: "button",
                    ...
                    n("div", ya, [
                      ...
                      H(" " + D(g(y)("grid.filters.label.extent")) + " ", 1),
                      z.value !== "disabled" && c.value.state.filterByExtent ? (_(), E("svg", ba, t[21] || (t[21] = [
                        n("g", { id: "done" }, [
                          n("path", { d: "M9 16.2L4.8 12l-1.4 1.4L9 19 21 7l-1.4-1.4L9 16.2z" })
                        ], -1)
                      ]))) : S("", !0)
                  ...
                  n("a", {
                    ...
                    ]))) : d.value ? S("", !0) : (_(), E("svg", Ca, t[24] || (t[24] = [
                    ...
                    H(" " + D(g(y)("grid.label.pinColumns")) + " ", 1),
                    d.value ? (_(), E("svg", La, t[25] || (t[25] = [
                      n("g", { id: "done" }, [
                        n("path", { d: "M9 16.2L4.8 12l-1.4 1.4L9 19 21 7l-1.4-1.4L9 16.2z" })
                      ], -1)
                    ]))) : S("", !0)
...
}), ka = /* @__PURE__ */ ge(Ma, [["__scopeId", "data-v-6c5e8a94"]]), Fa = /* @__PURE__ */ I({
  __name: "screen",
  props: {
    panel: {
      type: tt,
  ...
  setup(L) {
    const s = lt(), { t: e } = B(), a = N(() => s.currentId);
    return (l, o) => {
      const d = Ve("panel-screen");
      return _(), Xe(d, { panel: L.panel }, {
        header: ne(() => [
          H(D(g(e)("grid.title")), 1)
        ]),
        content: ne(() => [
          Ee(ka, {
            class: "rv-grid",
...
}), yr = /* @__PURE__ */ ge(Fa, [["__scopeId", "data-v-904e67ef"]]);
export {
  yr as default
};
