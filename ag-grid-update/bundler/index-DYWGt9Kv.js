...
import "tiny-emitter";
import { G as le, L as Te, F as xe } from "./main-CzU1FsrQ.js";
...
class ft extends Me {
  async init() {
    Object.entries(Le).forEach((b) => this.$iApi.$i18n.mergeLocaleMessage(...b)), this._parseConfig(this.config), Z(this.$vApp.$pinia).supportedTypes.forEach((b) => {
      const o = `${b.type}-icon`;
      this.$iApi.component(o, Ae(Se(/* @__PURE__ */ Object.assign({ "./icons/circle-icon.vue": () => import("./circle-icon-gBT25FAQ.js"), "./icons/edit-icon.vue": () => import("./edit-icon-Dn5ozk0L.js"), "./icons/point-icon.vue": () => import("./point-icon-BiHsH0j4.js"), "./icons/polygon-icon.vue": () => import("./polygon-icon-BsZ4QxKx.js"), "./icons/polyline-icon.vue": () => import("./polyline-icon-K4uZXX-U.js"), "./icons/rectangle-icon.vue": () => import("./rectangle-icon-2XQ3DCL7.js") }), `./icons/${b.type}-icon.vue`, 3)));
    });
