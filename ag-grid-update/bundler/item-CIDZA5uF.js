...
import { r as Ce, q as y, a as Ie, a4 as I, G as X, _ as ie, X as Te, p as Se, a6 as U, a7 as b, S as ze, a8 as O, a9 as ne } from "./main-CzU1FsrQ.js";
import "pinia";
...
const Ae = ["type", "aria-label", "checked", "disabled", "content"], ae = /* @__PURE__ */ Q({
  ...
  emits: ["focusItem"],
  setup(e, { emit: T }) {
    const { t: i } = re(), c = ue("iApi"), f = E(), $ = E(!1), s = Ie(), B = E(s.mobileView), Z = T, N = E(0), v = e, J = () => {
...
}), Je = /* @__PURE__ */ ie(Qe, [["__scopeId", "data-v-34dfeccd"]]), Ye = { class: "relative" }, _e = ["content"], et = {
  key: 0,
  ...
  setup(e) {
    ...
    s.legendItem instanceof y && C(s.legendItem.layer)?.sublayers.length > 0), g = (r) => r === U.Expand || r === U.Visibility ? s.legendItem.controlAvailable(r) : s.legendItem.layerControlAvailable(r), m = (r) => He(r), j = () => {
      ...
      g(I.Datatable) && W() && f.event.emit(X.GRID_TOGGLE, s.legendItem.layer);
    }, te = (r) => {
...
}), Sl = /* @__PURE__ */ ie(qt, [["__scopeId", "data-v-ea22b3ac"]]);
export {
  Sl as default
};
